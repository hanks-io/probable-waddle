    ...
    (function() {
      ...
      var F = {
        ...
        SG: [, [, , "(?:(?:1\\d|8)\\d\\d|7000)\\d{7}|[3689]\\d{7}", , , , , , , [8, 10, 11]], [
          ...
          ,
          [8]
        ], [, , "896[0-46-8]\\d{4}|(?:8(?:0[1-9]|[1-8]\\d|9[0-5])|9[0-8]\\d)\\d{5}", , , , "81234567", , , [8]], [, , "(?:18|8)00\\d{7}", , , , "18001234567", , , [10, 11]], [, , "1900\\d{7}", , , , "19001234567", , , [11]], [, , , , , , , , , [-1]], [, , , , , , , , , [-1]], [, , "(?:3[12]\\d|666)\\d{5}", , , , "31234567", , , [8]], "SG", 65, "0[0-3]\\d", , , , , , , , [[, "(\\d{4,5})", "$1", ["1[013-9]|77", "1(?:[013-8]|9(?:0[1-9]|[1-9]))|77"]], [, "(\\d{4})(\\d{4})", "$1 $2", ["[369]|8(?:0[1-9]|[1-9])"]], [, "(\\d{3})(\\d{3})(\\d{4})", "$1 $2 $3", ["8"]], [
          ,
          "(\\d{4})(\\d{4})(\\d{3})",
          "$1 $2 $3",
          ["7"]
        ...
        ZA: [, [, , "[1-79]\\d{8}|8\\d{4,9}", , , , , , , [5, 6, 7, 8, 9, 10]], [, , "50[0-2]\\d{6}|(?:2(?:0330|4302)|52087)0\\d{3}|(?:1[0-8]|2[1-378]|3[1-69]|4\\d|5[1346-8])\\d{7}", , , , "101234567", , , [9]], [
          ,
          ,
      ...
      function Ta() {
        return ";ext=" + I("20") + "|[  \\t,]*(?:e?xt(?:ensi(?:ó?|ó))?n?|ｅ?ｘｔｎ?|доб|anexo)[:\\.．]?[  \\t,-]*" + (I("20") + "#?|[  \\t,]*(?:[xｘ#＃~～]|int|ｉｎｔ)[:\\.．]?[  \\t,-]*") + (I("9") + "#?|[- ]+") + (I("6") + "#|[  \\t]*(?:,{2}|;)[:\\.．]?[  \\t,-]*") + (I("15") + "#?|[  \\t]*(?:,)+[:\\.．]?[  \\t,-]*") + (I("9") + "#?");
      }
      var Ua = new RegExp("(?:" + Ta() + ")$", "i"), Va = new RegExp("^[0-9０-９٠-٩۰-۹]{2}$|^[+＋]*(?:[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～*]*[0-9０-９٠-٩۰-۹]){3,}[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～*A-Za-z0-9０-９٠-٩۰-۹]*(?:" + Ta() + ")?$", "i"), Wa = /(\$\d)/, Xa = /^\(?\$1\)?$/;
      function Ya(a) {
      ...
      function ib(a, b, c) {
        ...
        null == b ? c = a : (e = b, b = u(e, 2), d = new RegExp(p(e, 1)), u(e, 5), e = u(e, 4), a = 2 == c && null != e && 0 < e.length ? a.replace(d, b.replace(Wa, e)) : a.replace(d, b), 3 == c && (a = a.replace(RegExp("^[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～]+"), ""), a = a.replace(RegExp("[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～]+", "g"), "-")), c = a);
        return c;
      }
      function kb(a, b) {
        var c = P;
      ...
      var xb = new D();
      q(xb, 11, "NA");
      var yb = RegExp("^[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～]*\\$1[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～]*(\\$\\d[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～]*)*$"), zb = /[- ]/;
      function wb(a, b) {
        b = K(b) ? Q(a.pa, b) : 0;
        a = O(a.pa, N(b));
        return null != a ? a : xb;
...
var index = getDefaultExportFromCjs(awesomePhonenumberExports);
var {
  AsYouType,
