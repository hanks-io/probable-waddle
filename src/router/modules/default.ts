...
import SecurityPage from '@/views/security/default/index.vue'
import GameCategoryPage from '@/views/game/category/index.vue'
import MainPage from '@/views/tabbar/MainPage/default/index.vue'
import SportGamePage from '@/views/game/category/sport/index.vue'
import RechargePage from '@/views/recharge/main/default/index.vue'
import BindCPFPage from '@/views/recharge/bindCPF/first/index.vue'
import CPFPage from '@/views/recharge/bindCPF/cpf/index.vue'
import UserReportPage from '@/views/user/report/default/index.vue'
import PromoPage from '@/views/tabbar/tabs/promo/default/index.vue'
import ActivityVipPage from '@/views/activity/vip/default/index.vue'
import InicioPage from '@/views/tabbar/tabs/inicio/default/index.vue'
import PerfilPage from '@/views/tabbar/tabs/perfil/default/index.vue'
import SecurityBindPage from '@/views/security/default/bind/index.vue'
import WithdrawMainPage from '@/views/withdraw/main/default/index.vue'
import LimitGameList from '@/views/withdraw/limitGame/default/index.vue'
import WithdrawSubPage from '@/views/withdraw/subView/default/index.vue'
import RebateRecordPage from '@/views/activity/rebate/default/record.vue'
import AuditDetails from '@/views/withdraw/auditDetails/default/index.vue'
import NotificationPage from '@/views/user/notification/default/index.vue'
import RechargeRecordPage from '@/views/recharge/record/default/index.vue'
import SecurityVerifyPage from '@/views/security/default/verify/index.vue'
import ActivityAgencyPage from '@/views/activity/agency/default/index.vue'
import ActivityCustomPage from '@/views/activity/custom/default/index.vue'
import SecurityConfirmPage from '@/views/security/default/confirm/index.vue'
import WithdrawPasswordPage from '@/views/withdraw/password/default/index.vue'

import ActivityAgencyDetailsPage from '@/views/activity/agency/first/details.vue'
import NotificationDetailPage from '@/views/user/notification/default/detail/index.vue'
import WithdrawPWCompletion from '@/views/withdraw/passwordCompletion/default/index.vue'
import ActivityRechargeRewardPage from '@/views/activity/rechargeReward/default/index.vue'
...
import SpreadPage from '@/views/spread/default/index.vue'
