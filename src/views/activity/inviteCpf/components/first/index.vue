    ...
    <ion-content>
      <section>
        <div class="w-full h-full pb-[7.5rem] relative">
          ...
          <!-- 可领取金额 -->
          <div class="flex justify-center invite-cpf-available items-baseline">
          ...
          <div class="mt-[1.5rem]">
            ...
            <div class="flex-center">
              <img class="w-[7.5rem] h-[0.75rem]" src="/images/inviteCpf/invite-cpf-explanation.png" alt="" />
              <div class="mx-[0.5rem] invite-cpf-rule-title font-medium">{{ $t('activity.appreciation13') }}</div>
              <img class="w-[7.5rem] h-[0.75rem] rotate-180" src="/images/inviteCpf/invite-cpf-explanation.png" alt="" />
            </div>
            <!-- 规则内容 -->
            <div class="px-[1.5rem] mt-[0.75rem]">
              <div class="w-full invite-cpf-rule-content keep-space px-[0.875rem] py-[0.75rem]">
...
<style scoped lang="less">
  ...
  @import '@/views/activity/inviteCpf/components/first/styles/base-index.less';
</style>
